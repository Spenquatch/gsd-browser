...
✅ CORRECT: {"action": [{"done": {"success": true, "text": "Result..."}}]}
❌ WRONG: {"done": {"success": true, "text": "..."}}
❌ WRONG: {"thinking": "...", "done": {...}}
...
✅ CORRECT: "action": [{"done": {"success": true, "text": "Completed task. Result is..."}}]
❌ WRONG: "done": {"success": true, "text": "..."}
</task_completion_rules>
<action_rules>
...
- REMEMBER: The action field must ALWAYS be an array, even with a single action.
</action_rules>
...
<output>
⚠️ **CRITICAL: You must ALWAYS respond with valid JSON in this EXACT format** ⚠️
{{
...
✅ CORRECT - Single action (still in array):
{
  "thinking": "...",
  "evaluation_previous_goal": "...",
  "memory": "...",
  "next_goal": "Navigate to the homepage",
  "action": [{"navigate": {"url": "https://example.com"}}]
}

✅ CORRECT - Multiple actions (in array):
{
  "thinking": "...",
  "evaluation_previous_goal": "...",
  "memory": "...",
  "next_goal": "Fill and submit search form",
  "action": [
    {"input_text": {"index": 10, "text": "search query"}},
    {"click_element": {"index": 12}}
  ]
}

✅ CORRECT - Done action (wrapped in array):
{
  "thinking": "Task is complete...",
  "evaluation_previous_goal": "Successfully gathered all required information. Verdict: Success",
  "memory": "Collected all 5 items requested.",
  "next_goal": "Return final results to user.",
  "action": [{"done": {"success": true, "text": "Found 5 products: ..."}}]
}

❌ WRONG - Missing action field:
{
  "thinking": "...",
  "memory": "...",
  "next_goal": "..."
  // ERROR: No "action" field!
}

❌ WRONG - action is not an array:
{
  "thinking": "...",
  "memory": "...",
  "next_goal": "...",
  "action": {"navigate": {"url": "..."}}  // ERROR: Should be [{"navigate": ...}]
}

❌ WRONG - done at top level:
{
  "thinking": "...",
  "done": {"success": true, "text": "..."}  // ERROR: done must be inside action array
}

**REMEMBER:**
- Action list should NEVER be empty
- The action field must ALWAYS be an array: [...]
- Even a single action must be in an array
- The done action MUST be inside the action array
- NEVER output done, navigate, click, or any action at the top level
</output>
